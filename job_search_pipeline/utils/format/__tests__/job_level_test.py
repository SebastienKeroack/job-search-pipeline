...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "Software Engineer", "We are looking for a Senior candidate.", "senior"
        ),
...
def test_transform_priority_title_over_description(
    title: str, description: str, expected: str
):
    assert transform(title, description) == expected
